                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 bg-white border-b border-gray-200">
                            <div>select con los habitos</div>
                            <div>
                                <div>
                                    mostrar porcentaje de productividad
                                </div>
                                <div>
                                    mostrar pordentaje de mejora
                                </div>
                            </div>
                            <div>
                                grafica con numero de goals de cada tarea
                            </div>
                            <div>
                                select con las tareas
                            </div>
                            <div>
                                select de semana, mes año para mostrar en la grafica
                            </div>
                            <div>boton de aplicar filtros</div>
                            {/*
                            <button 
                                    type="button" 
